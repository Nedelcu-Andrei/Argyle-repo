...
class UpworkScraperTests(unittest.TestCase):
    ...
    def test_collect_contact_info_data(self):
        ...
        self.page.click('#main > div > div > div.col-md-3.d-none.d-md-block > nav > div.user-settings-nav-container > div:nth-child(2) > ul > li.up-settings-list-item.up-settings-list-item-contact > a')
        assert self.page.inner_text('#main > div > div > div.col-md-9 > main > div:nth-child(2) > header > h2').strip() == 'Account'
