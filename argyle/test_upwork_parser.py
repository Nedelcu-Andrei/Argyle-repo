...
class UpworkParserTests(unittest.TestCase):
    ...
    def create_test_context(self):
        ...
        self.parse_contact_info_data_body = map_html_body[
            'parse_contact_info_data']
    ...
    def test_invalid_parse_homepage(self):
        assert self.parser.parse_homepage(self.invalid_data_list,
                                          self.data_dict) is None
    ...
    def test_invalid_parse_profile_data(self):
        assert self.parser.parse_profile_data(self.invalid_tuple_list,
                                              self.user_profile_data) is None

    def test_valid_parse_profile_page(self):
        self.parser.parse_profile_data(self.parse_profile_data_body,
    ...
    def test_invalid_parse_contact_info_data(self):
        assert self.parser.parse_contact_info_data(self.invalid_error,
                                                   self.user_profile_data) is None

    def test_valid_parse_contact_info_data(self):
        self.parser.parse_contact_info_data(self.parse_contact_info_data_body,
                                            self.user_profile_data)
